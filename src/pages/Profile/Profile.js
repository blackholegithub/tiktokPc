                ...
                <div className={cx('info')}>
                    <div className={cx('basic')}>
                        ...
                        <div className={cx('text')}>
                            ...
                            {isFollowing ?
                                <Button primary outline style={{ minWidth: '208px' }} onClick={handleFollow}>Following</Button> :
                                <Button primary  style={{ minWidth: '208px' }} onClick={handleFollow}>Follow</Button>
                            }
                        </div>
                    </div>
