...
function SuggestedAccounts({ sidebar, data, following, ...passProps }) {
                    ...
                    <div tabIndex="-1" {...attrs}>
                        <Popper className={cx('account-tab')}>
                            <div className={cx('header')}>
                             ...
                             {following?  <Button outline onClick={context.handleShowModal}>Following</Button> :   <Button primary onClick={context.handleShowModal}>Follow</Button>}
                            </div>
