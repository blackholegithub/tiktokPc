        ...
        <div className={cx('wrapper', { active })}>
            <div className={cx('container')}>
                <HeadlessTippy
                    ...
                    zIndex="99"
                    onShow={(instance) =>{
                        instance.popper.querySelector('.closeGetApp').addEventListener('click', () => {
                          instance.hide();
                        })}}
                    onHide={(instance) =>{
                        instance.popper.querySelector('.closeGetApp').removeEventListener('click', () => {
                          instance.hide();
                        })}}
                        ...
                        <div tabIndex="-1" {...attrs}>
                            <Popper>
                                <div className={cx('tippy-wrapper')}>
                                    ...
                                    <div className={cx('close-btn','closeGetApp')} > <XMarkIcon height={'2rem'} width={'2rem'} /> </div>
                ...
                <button className={cx('getapp-btn','closeGetApp')}>Get app</button>
                </HeadlessTippy>
            </div>
