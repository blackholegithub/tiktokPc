            ...
            <div className={cx('wrapper')}>
                <div className={cx('container')}>
                    ...
                    <div className={cx('inner')}>
                       ...
                       {!context.currentUser? <Button style={{ height: '44px', margin: '16px 0px', backgroundColor:'red', width: '100%' ,color:'#fff',textDecorationLine:'underline' }} onClick ={handleLogin}>Click Login as a customer</Button>: <></>}
